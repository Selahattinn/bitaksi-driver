...
import (
	...
	"github.com/Selahattinn/bitaksi-driver/internal/server"
	"github.com/Selahattinn/bitaksi-driver/internal/version"
...
var (
	...
	logFileFlag    = flag.String("log", "bitaksi-driver.log", "Path to the log file.")
...
func main() {
	if *versionFlag {
		fmt.Fprintln(os.Stdout, version.Print("bitaksi-driver"))
		os.Exit(0)
	}
